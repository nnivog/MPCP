...
def sample_file(fname):
    """Generate sample files on-the-fly — no pre-existing file required."""
...
def _gen_sample_employees():
    ...
    ws.append(["<- Fill from row 3","","Level: 1=HOD 2=Mgr 3=Exec","","","",""])
    rows = [
        ("EMP-001","Govinda Upadhyay","Head of Department",1,"HOD","","govinda@sipradi.com"),
        ("EMP-002","Sandeep Gupta Kanu","Vehicle Import & Logistics",2,"Vehicle","EMP-001","sandeep@sipradi.com"),
        ("EMP-003","Sagar Koirala","Custom Clearance Support",2,"Vehicle","EMP-001","sagar@sipradi.com"),
        ("EMP-004","Rajeshwori Maharjan","Registration & WOW Manager",2,"Registration","EMP-001","rajeshwori@sipradi.com"),
        ("EMP-005","Laxmi","Vehicle Registration Exec.",3,"Registration","EMP-004","laxmi@sipradi.com"),
        ("EMP-006","Ishwor Shrestha","Registration Process",3,"Registration","EMP-004","ishwor@sipradi.com"),
        ("EMP-007","Hari Prasad Pandey","Customs Agent Coord.",3,"Vehicle","EMP-002","hari@sipradi.com"),
        ("EMP-008","Aashish Patel","Physical Stock Verification",3,"Stock","EMP-001","aashish@sipradi.com"),
        ("EMP-009","Bipin KC","Vehicle Delivery",3,"Vehicle","EMP-002","bipin@sipradi.com"),
        ("EMP-010","Mahesh Adhikari","Vehicle Movement",3,"Vehicle","EMP-002","mahesh@sipradi.com"),
        ("EMP-011","Rose Basnet","Goods Receipt & GRN",2,"Warehouse","EMP-001","rose@sipradi.com"),
        ("EMP-012","Sanjay Rauniyar","Warehouse Receipt",3,"Warehouse","EMP-011","sanjay@sipradi.com"),
        ("EMP-013","Rabindra","Goods Clearance",3,"Warehouse","EMP-011","rabindra@sipradi.com"),
        ("EMP-014","Ranjit Chhetri","Goods Dispatch",3,"Warehouse","EMP-011","ranjit@sipradi.com"),
        ("EMP-015","Purshottam Kr. Patel","Border Clearance",3,"Warehouse","EMP-011","purshottam@sipradi.com"),
        ("EMP-016","Babim / Manoj","Operations Support",3,"Ops","EMP-001","babim@sipradi.com"),
    ]
    for r in rows: ws.append(list(r))
    _style_header(ws)
    for col, w in [('A',12),('B',28),('C',32),('D',8),('E',15),('F',12),('G',28)]:
...
def _gen_sample_mps():
    ...
    ws.append(["Ref","Title","Target","Frequency","KPI_Total","KPI_C","KPI_NC","Owner_Codes"])
    rows = [
        ("HODL-1","Fully compliant and timely vehicle import","1 Day","Monthly",3299,3183,116,"EMP-002,EMP-003"),
        ("HODL-2","100% NIAC Claim resolution within 120 Days","120 Days","Fortnightly",0,0,0,"EMP-002,EMP-003"),
        ("HODL-3","Error and Penalty free registration process","15 Days","Fortnightly",1639,1420,219,"EMP-002,EMP-004"),
        ("HODL-4","100% ownership requests timebound","3 Days","Weekly",1639,1531,108,"EMP-004,EMP-002"),
        ("HODL-5","Vehicle readiness and driver arrangements within 24hrs","24 Hours","Fortnightly",3466,3396,70,"EMP-002,EMP-003,EMP-010"),
        ("HODL-6","Vehicle delivery hygiene and cost control","24 Hours","Quarterly",5880,5580,300,"EMP-002,EMP-003,EMP-010"),
        ("HODL-7","100% WOW update within 15 days CV / 10 days PV","10-15 Days","Monthly",0,0,0,"EMP-004"),
        ("HODL-8","Monthly physical verification of new vehicles","Monthly","Monthly",174,174,0,"EMP-004,EMP-008"),
        ("HODL-9","Goods availability within 5 days of border arrival","5 Days","Fortnightly",136,127,9,"EMP-002,EMP-011,EMP-014"),
        ("HODL-10","Performance visibility and cost optimization 20% reduction","20% Reduction","Monthly",1639,1194,445,"EMP-004,EMP-002,EMP-011"),
        ("HODL-11","Employee motivation and process capability","Per Calendar","Quarterly",0,0,0,"EMP-001"),
        ("HODL-12","Strengthen monitoring and review mechanism","Fortnightly","Fortnightly",0,0,0,"EMP-004"),
    ]
    for r in rows: ws.append(list(r))
    _style_header(ws)
    ws.column_dimensions['A'].width=10; ws.column_dimensions['B'].width=55; ws.column_dimensions['H'].width=25
...
def _gen_sample_cps():
    ...
    ws.append(["Ref","Title","Target","Frequency","Source","MP_Ref","Owner_Codes"])
    rows = [
        ("LM-VEH-1","Tracking of New Vehicles till arrival at border","100%","Monthly","Manual","HODL-1","EMP-002"),
        ("LM-VEH-2-B","On time custom clearance within 3 days of CC memo","3 Days","Daily","System","HODL-1","EMP-002"),
        ("LM-VEH-2-S","Custom clearance monitoring","3 Days","Daily","System","HODL-1","EMP-003"),
        ("LM-VEH-3-B","100% vehicles with valid GST before expiry","90 Days","Weekly","System","HODL-1","EMP-002"),
        ("LM-VEH-3-S","GST validity monitoring","90 Days","Weekly","System","HODL-1","EMP-003"),
        ("LM-VEH-4-B","100% POE submission within 90 days of CC","90 Days","Weekly","Manual","HODL-1","EMP-002"),
        ("LM-VEH-4-S","POE submission monitoring","90 Days","Weekly","","HODL-1","EMP-003"),
        ("LM-VEH-5-B","Registration of Vehicles within 15 Days of PP","15 Days","Weekly","System","HODL-3","EMP-002"),
        ("LM-VEH-5-A","Registration tracking","15 Days","Weekly","","HODL-3","EMP-004"),
        ("LM-VEH-6-B","Ownership Transfer within 3 Days","3 Days","Daily","System","HODL-4","EMP-004"),
        ("LM-VEH-6-A","Ownership transfer support","3 Days","Daily","","HODL-4","EMP-002"),
        ("LM-VEH-7-B","Final Delivery of Vehicles within 24 Hours","24 Hours","Daily","System","HODL-5","EMP-002"),
        ("LM-VEH-7-S","Final Delivery coordination","24 Hours","Daily","","HODL-5","EMP-003"),
        ("LM-VEH-7-A","Final Delivery support","24 Hours","Daily","","HODL-5","EMP-010"),
        ("LM-VEH-8-B","Vehicle Dispatch to Locations within 24 hrs","24 Hours","Daily","","HODL-6","EMP-002"),
        ("LM-VEH-8-S","Dispatch coordination","24 Hours","Daily","System","HODL-6","EMP-003"),
        ("LM-VEH-8-A","Dispatch support","24 Hours","Daily","","HODL-6","EMP-010"),
        ("LM-VEH-11","WOW update within 10/15 Days of Delivery PV/CV","10/15 Days","Weekly","System","HODL-7","EMP-004"),
        ("LM-VEH-12","Monthly Physical Verification of new vehicles","Monthly","Monthly","Manual","HODL-8","EMP-004"),
        ("LM-WH-1","Custom Clearance of Goods within 2 working days","2 Days","Daily","Manual","HODL-9","EMP-002"),
        ("LM-WH-2","GRN and Verification of Goods within 2 Days of CC","2 Days","Daily","System","HODL-9","EMP-002"),
        ("LM-WH-3-B","Goods delivered as per SLA","SLA","Daily","System","HODL-9","EMP-002"),
        ("LM-WH-3-A","Goods delivery SLA monitoring","SLA","Daily","System","HODL-9","EMP-011"),
        ("LM-WH-4-B","Handling discrepancies 100% closure","100%","Daily","","HODL-10","EMP-002"),
        ("LM-WH-4-A","Discrepancy closure","100%","Daily","","HODL-10","EMP-011"),
        ("LM-VEH-13","Sahamati Just in Time for tax reduction","20% Reduction","Daily","","HODL-10","EMP-004"),
        ("LM-VH-14","Conduct Periodic Review Meeting","Fortnightly","Fortnightly","","HODL-12","EMP-004"),
    ]
    for r in rows: ws.append(list(r))
    _style_header(ws)
    ws.column_dimensions['A'].width=16; ws.column_dimensions['B'].width=55; ws.column_dimensions['G'].width=18
    return _xlsx_out(wb, 'Sample_CheckingPoints.xlsx')

def _gen_sample_perf():
    rows = [
        ["FY","BS_Month","Emp_Code","MP_Ref","CP_Ref","Metric",
         "Total","Compliant","Non_Compliant","Pct_Compliant","Pct_NC",
         "Target_Val","Actual_Val","Unit","Status","Notes"],
        ["2081-82","Shrawan","EMP-002","HODL-1","LM-VEH-1","Vehicle Border Tracking",410,398,12,97.07,2.93,100,97,"%","C","All tracked"],
        ["2081-82","Shrawan","EMP-002","HODL-1","LM-VEH-2-B","CC within 3 Days",410,390,20,95.12,4.88,3,2.6,"Days","C","On track"],
        ["2081-82","Shrawan","EMP-003","HODL-1","LM-VEH-2-S","CC Monitoring",260,248,12,95.38,4.62,3,2.9,"Days","C",""],
        ["2081-82","Shrawan","EMP-004","HODL-3","LM-VEH-5-A","Registration 15 Days",380,370,10,97.37,2.63,15,13,"Days","C","Improved"],
        ["2081-82","Shrawan","EMP-004","HODL-4","LM-VEH-6-B","Ownership Transfer",210,207,3,98.57,1.43,3,2.2,"Days","C","Best ever"],
        ["2081-82","Shrawan","EMP-011","HODL-9","LM-WH-3-A","Goods SLA Delivery",105,103,2,98.10,1.90,2,1.8,"Days","C","Better"],
        ["2081-82","Bhadra","EMP-002","HODL-1","LM-VEH-1","Vehicle Border Tracking",450,446,4,99.11,0.89,100,99,"%","C",""],
        ["2081-82","Bhadra","EMP-002","HODL-1","LM-VEH-2-B","CC within 3 Days",450,436,14,96.89,3.11,3,2.4,"Days","C",""],
        ["2081-82","Bhadra","EMP-004","HODL-3","LM-VEH-5-A","Registration 15 Days",400,395,5,98.75,1.25,15,12,"Days","C",""],
        ["2081-82","Ashwin","EMP-002","HODL-1","LM-VEH-1","Vehicle Border Tracking",480,470,10,97.92,2.08,100,98,"%","C",""],
        ["2081-82","Ashwin","EMP-002","HODL-1","LM-VEH-2-B","CC within 3 Days",480,458,22,95.42,4.58,3,2.7,"Days","C",""],
        ["2081-82","Ashwin","EMP-004","HODL-4","LM-VEH-6-B","Ownership Transfer",220,218,2,99.09,0.91,3,2,"Days","C",""],
        ["2081-82","Kartik","EMP-002","HODL-1","LM-VEH-1","Vehicle Border Tracking",390,374,16,95.90,4.10,100,96,"%","C",""],
        ["2081-82","Kartik","EMP-011","HODL-9","LM-WH-3-A","Goods SLA Delivery",98,94,4,95.92,4.08,2,2.1,"Days","NC","Slight over"],
    ]
    out = io.StringIO(); w = csv.writer(out)
